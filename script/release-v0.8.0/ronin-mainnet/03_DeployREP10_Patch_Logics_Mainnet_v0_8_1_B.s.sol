...
contract Migration__03_DeployREP10_Patch_Logics_Mainnet_Release_V0_8_1B is REP10_Config_Mainnet_Base {
  using LibProxy for *;
  using StdStyle for *;
  ...
  function _deployRoninValidatorSetREP10MigratorLogic() internal {
    ...
    console.log(
      "Verify Prev Logic Before REP-10 Link:",
      string.concat("https://app.roninchain.com/address/", vm.toString(prevLogic))
    );
